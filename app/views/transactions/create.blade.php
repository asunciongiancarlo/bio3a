...
@section('content')
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select name="invoice_status" data-parsley-required class="form-control">
                    <option value="With PDC"  {{  ($_id['invoice_status'])=='With PDC' ? 'selected' : '' }}>With PDC</option>
    ...
    <script type="text/javascript">
        ...
        function A3init()
        {
            ...
            $("select[name='quantity_no[]']").on('change', function(){
                var unit_price = $(this).closest('.item-list-row').find('input')[0];
                var quantity_no = $(this).val();
                var total_amount_holder = $(this).closest('.item-list-row').find('input')[1];
            ...
            $("input[name='unit_price[]']").on('keyup', function(){
                ...
                var x = $(this).closest('.item-list-row').find('select')[1];
                var total_amount_holder = $(this).closest('.item-list-row').find('input')[1];
                var quantity = $(x).val();
                unit_price = parseFloat(unit_price.replace(/,/g, ''));
